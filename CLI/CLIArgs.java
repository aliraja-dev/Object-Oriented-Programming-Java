            ...
            try {
                switch (args[count]) {
                    ...
                    case "-v":// Display version information
                        ...
                        count++;
                        break;
                    case "-f":// This is an example to show you how to handle when you have a parameter that
                              // takes info
                        String fileName = args[count + 1];// We are getting the filename so set it to the string after
                                                          // -f
                        ...
                        break;
                    default:// If none of your cases match then this is an unrecognized parameter and we
                            // will exit.
